...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        ...
        <section class="max-w-[990px] p-6 mx-auto bg-slate-100 rounded-md shadow-md dark:bg-gray-800 mt-10">
            <h1 class="text-xl font-bold text-slate-900 capitalize dark:text-slate-900">Edit Data blog</h1>
            <form action="{{ route('blog.update', $dataById->id_blog) }}" method="post"
                    ...
                    <div class="w-72">
                        <div class="relative h-10 w-full min-w-[350px] mt-5">
                            <label class="block text-sm">
                                <span class="block text-sm font-medium text-slate-900">Author</span>
                                <input
                                  ...
                                  placeholder="author" name="author_blog"
                                  value="{{$dataById->author_blog }}" 
                                />
                    ...
                    <div class="w-72">
                        <div class="relative h-[120px] w-full min-w-[350px] mt-5">
                            <label class="block mt-4 text-sm">
                                ...
                                <textarea class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-[#203e59] focus:outline-none focus:shadow-outline-[#203e59] dark:focus:shadow-outline-gray" rows="3" placeholder="Deskripsi" name="judul_blog">{{ $dataById->judul_blog }}</textarea>
                            </label>
                        </div>
                    </div>
                    <div class="w-72">
                        <div class="relative h-[120px] w-full min-w-[350px] mt-5">
                            <label class="block mt-4 text-sm">
                                ...
                                <textarea class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-[#203e59] focus:outline-none focus:shadow-outline-[#203e59] dark:focus:shadow-outline-gray" rows="3" placeholder="Deskripsi" name="deskripsi_blog">{{ $dataById->deskripsi_blog }}</textarea>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="relative h-[120px] w-full min-w-[350px] mt-5">
                            <label class="block mt-4 text-sm">
                                ...
                                <textarea
                                  ...
                                  rows="3"
                                  placeholder="Link" name="link_blog" value="{{ $dataById->link_blog }}" 
                                >{{ $dataById->link_blog }}</textarea>
                              </label>
                        </div>
                    </div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="file-upload"
                                        ...
                                        <img src="{{ asset($dataById->gambar_blog) }}
                                        " alt="" class="w-48">
                                        <input id="file-upload" name="gambar_blog" type="file" class="sr-only">
                                    </label>
