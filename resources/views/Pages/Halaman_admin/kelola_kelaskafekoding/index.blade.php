    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
            ...
            <div class="flex justify-between">
                ...
                <!-- Sisi kanan -->
                <div class="px-6 my-6">
                    <a href="{{ route('kelaskafekoding.create') }}"
            ...
            <table id="example" class="display border border-slate-200 " style="width:100%">
                <thead>
                    <tr >
                        ...
                        <th class="border border-slate-200  text-center">Kelas</th>
                        <th class="border border-slate-200  text-center">Jam Awal</th>
                        <th class="border border-slate-200  text-center">Jam Akhir</th>
                        <th class="border border-slate-200  text-center">Ruangan</th>
                ...
                <tbody>
                    ...
                    @foreach ($kelaskafekoding as $baris)
                        <tr>
                            ...
                            <td class="border border-slate-200 whitespace-normal break-all text-center">
                                {{ $baris->kelas_kelaskafekoding }}
                            </td>
                            <td class="border border-slate-200 whitespace-normal break-all text-center">
                                {{ $baris->jam_awal_kelaskafekoding }}
                            </td>
                            <td class="border border-slate-200 whitespace-normal break-all text-center">
                                {{ $baris->jam_akhir_kelaskafekoding }}
                            </td>
                            <td class="border border-slate-200 whitespace-normal break-all text-center">
                                {{ $baris->ruangan_kelaskafekoding }}
                            </td>
                            <td class="border border-slate-200 whitespace-normal break-all text-center">
                                <a href="{{ $baris->link_kelaskafekoding }}" style="color: blue; text-decoration: underline;">{{ $baris->link_kelaskafekoding }}</a>
                            </td>
                                ...
                                <div class="flex items-center justify-center text-sm">
                                    ...
                                    <div class="relative hidden w-32 h-32 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-lg"
                                            src="{{ asset($baris->gambar_kelaskafekoding) }}" alt="" loading="lazy" />
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center justify-center text-sm">
                                    <a href="{{ route('kelaskafekoding.edit', $baris->id_kelaskafekoding) }}">
                                    ...
                                    <form action="{{ route('kelaskafekoding.destroy', $baris->id_kelaskafekoding) }}" method="post" style="display: inline-block">
                                        @csrf
                                        @method('DELETE')
