...
@section('content')
    ...
    <main class="h-full pb-16 overflow-y-auto">
        ...
        <section class="max-w-[990px] p-6 mx-auto bg-slate-100 rounded-md shadow-md dark:bg-gray-800 mt-10">
            <h1 class="text-xl font-bold text-slate-900 capitalize dark:text-slate-900">Tambah Data kelaskafekoding</h1>
            @if (session('success'))
            ...
            @endif
            <form action="{{ route('kelaskafekoding.store') }}" method="post" enctype="multipart/form-data">
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div class="w-72">
                        <div class="relative h-10 w-full min-w-[350px] mt-5">
                            <label class="block text-sm">
                                <span class="block text-sm font-medium text-slate-900">Ruangan</span>
                                <input
                                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-[#203e59] focus:outline-none focus:shadow-outline-[#203e59] dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                  placeholder="ruangan" name="ruangan_kelaskafekoding"
                                />
                              </label>
                        </div>
                    </div>
                        ...
                        <div class="relative h-[120px] w-full min-w-[350px] mt-5">
                            <label class="block mt-4 text-sm">
                                ...
                                <textarea
                                  ...
                                  rows="3"
                                  placeholder="Link" name="link_kelaskafekoding"
                                ></textarea>
                              </label>
                        </div>
                    </div>
