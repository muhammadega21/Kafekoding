                ...
                <tbody>
                    ...
                    @foreach ($hero as $baris)
                        <tr>
                                ...
                                <div class="flex items-center justify-center text-sm">
                                    ...
                                    <div class="relative hidden w-32 h-32 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-lg"
                                            src="{{ asset($baris->gambar_hero) }}" alt="" loading="lazy" />
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="border border-slate-200">
                                <div class="flex items-center justify-center text-sm">
                                    <a href="{{ route('hero.edit', $baris->id_hero) }}">
                                    ...
                                    <form action="{{ route('hero.destroy', $baris->id_hero) }}" method="post" style="display: inline-block">
                                        @csrf
                                        @method('DELETE')
